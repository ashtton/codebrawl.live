    ...
    <div className="relative min-h-dvh bg-neutral-950">
      ...
      {show && (
        <div className="fixed inset-0 z-50 grid place-items-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-neutral-900/90 via-neutral-950/95 to-black/95 backdrop-blur-md" />
          ...
          <div className="relative w-[min(92vw,520px)] origin-center rounded-2xl border border-white/10 bg-neutral-900/40 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-black/40 backdrop-blur-xl text-white
            ...
            <div className="absolute -inset-px rounded-2xl bg-[radial-gradient(40%_60%_at_50%_-20%,rgba(255,255,255,0.08),rgba(255,255,255,0))] pointer-events-none" />

            <div className="mb-3 flex items-center gap-2.5">
              <span className="inline-flex h-2.5 w-2.5 animate-pulse rounded-full bg-emerald-400/80 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]" />
            ...
            <div className="mt-2">
              ...
              <p className="mt-2 text-xs text-white/60">Hold tight while we establish a secure connection.</p>
            </div>
          </div>
        </div>
      )}
