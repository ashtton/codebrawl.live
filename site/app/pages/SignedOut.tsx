          ...
          <span
            ...
            0 players currently playing
                    ...
                    <h1 className="mt-6 text-5xl font-black leading-tight tracking-tight sm:text-6xl">
                        <span className="text-white">Code Brawl</span>
                    </h1>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-4">
                        <SignInButton>
                            <button
                                className="group relative inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-blue-500/20 ring-1 ring-white/10 transition-all hover:bg-blue-500 hover:shadow-blue-400/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400">
                                <span className="relative z-10">Sign in to play</span>
                                <span
                                    className="absolute inset-0 -z-0 rounded-lg opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100 bg-blue-600"/>
                            </button>
                        </SignInButton>
                    </div>
